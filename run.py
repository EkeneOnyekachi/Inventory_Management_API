...
from utils.const import TOKEN_DISCRIPTION, TOKEN_SUMMARY, DB_URL_PRODUCTION
...
@Blog.post("/token", description=TOKEN_DISCRIPTION, summary=TOKEN_SUMMARY, tags=["Security"])
